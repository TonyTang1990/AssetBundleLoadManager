...
public class AtlasManager : SingletonTemplate<AtlasManager>
{
    ...
    /// <param name="loadmethod">资源加载方式</param>
    /// <returns></returns>
    public void setRawImage(TRawImage trawimg, string texturepath, TResource.ResourceLoadType loadtype = TResource.ResourceLoadType.NormalLoad, TResource.ResourceLoadMethod loadmethod = TResource.ResourceLoadMethod.Sync)
    {
        DIYLog.Assert(trawimg == null, "setRawImage不允许传空TRawImage!");
