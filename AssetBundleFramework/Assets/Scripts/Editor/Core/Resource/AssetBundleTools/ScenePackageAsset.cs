...
/// 场景资源类型的Asset打包抽象
/// </summary>
public class ScenePackageAsset : PackageAsset {
    ...
    public ScenePackageAsset(Object asset, Object dependentasset = null) : base(asset, dependentasset)
    {
