/*
 * Description:             AnimationController资源类型的Asset打包抽象
 * Author:                  tanghuan
...
/// <summary>
/// AnimationController资源类型的Asset打包抽象
/// </summary>
public class AnimationControllerPackageAsset : PackageAsset {
    ...
    public AnimationControllerPackageAsset(Object asset, Object dependentasset = null) : base(asset, dependentasset)
    {
