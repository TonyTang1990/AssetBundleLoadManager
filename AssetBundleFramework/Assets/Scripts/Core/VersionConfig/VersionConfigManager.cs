...
/// <summary>
/// VersionConfigManager.cs
/// 游戏版本信息管理单例类
/// </summary>
public class VersionConfigManager : SingletonTemplate<VersionConfigManager>, IModuleInterface
{
    /// <summary>
    /// 模块名
    /// </summary>
    ...
    /// 包内版本信息文件存储路径
    /// </summary>
    private readonly string mInnerVersionConfigFilePath = ConfigFolderPath + mVersionConfigFileName;

#if UNITY_EDITOR
    /// <summary> 包外资源版本信息文件存储目录 /// </summary>
    private readonly string OutterVersionConfigSaveFileFullPath = Application.persistentDataPath + ConfigFolderPath + mVersionConfigFileName + ".json";
