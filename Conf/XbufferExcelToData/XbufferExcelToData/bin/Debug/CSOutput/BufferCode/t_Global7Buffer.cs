namespace xbuffer
{
    public static class t_Global7Buffer
    {
        public static t_Global7 deserialize(byte[] buffer, ref uint offset)
        {
        ...
        public static void serialize(t_Global7 value, XSteam steam)
        {
