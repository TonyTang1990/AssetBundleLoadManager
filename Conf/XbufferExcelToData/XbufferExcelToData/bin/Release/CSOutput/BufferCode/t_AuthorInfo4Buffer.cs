namespace xbuffer
{
    public static class t_AuthorInfo4Buffer
    {
        public static t_AuthorInfo4 deserialize(byte[] buffer, ref uint offset)
        {
        ...
        public static void serialize(t_AuthorInfo4 value, XSteam steam)
        {
