namespace xbuffer
{
    public static class t_AuthorInfo7Buffer
    {
        public static t_AuthorInfo7 deserialize(byte[] buffer, ref uint offset)
        {
        ...
        public static void serialize(t_AuthorInfo7 value, XSteam steam)
        {
