namespace xbuffer
{
    public static class t_AuthorInfo3Buffer
    {
        public static t_AuthorInfo3 deserialize(byte[] buffer, ref uint offset)
        {
        ...
        public static void serialize(t_AuthorInfo3 value, XSteam steam)
        {
