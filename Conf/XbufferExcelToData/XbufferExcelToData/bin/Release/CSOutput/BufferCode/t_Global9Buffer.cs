namespace xbuffer
{
    public static class t_Global9Buffer
    {
        public static t_Global9 deserialize(byte[] buffer, ref uint offset)
        {
        ...
        public static void serialize(t_Global9 value, XSteam steam)
        {
